...
const ChartCard = ({type ='line', data}) => {
    ...
    const renderCharts = () => {
        if (type === 'line'){
            return (
                <>  
                    <h3 className="chart-title">Net Income</h3>
            ...
            return (
                <>  
                    <h3 className="chart-title">Revenue and Operating Expense</h3>
            ...
            return(
                <>  
                    <h3 className="chart-title">Net Profit Margin</h3>
            ...
            return (
                <>  
                    <h3 className="chart-title">All Statistics</h3>
